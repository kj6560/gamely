            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">BetMasters</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Layouts">App Sliders</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/dashboard/createAppSlider" class="menu-link">
                                    <div data-i18n="Without menu">Create Sliders</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/dashboard/appSliders" class="menu-link">
                                    <div data-i18n="Without navbar">List Sliders</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/dashboard/listGames" class="menu-link">
