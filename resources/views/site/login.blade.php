        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <form id="login-form" action="/loginAuthentication" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" id="login-otp" class="form-control" name="password" placeholder="Enter Password" required>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block">Login</button>
                        <p class="text-center">Not a member? <a href="/register" onclick="toggleForms()">Click here to register</a></p>
